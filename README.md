...
- Android app: [covtakt-android](https://github.com/bvantagelimited/covtakt-android)
- iOS app: [covtakt-ios](https://github.com/bvantagelimited/covtakt-ios)
- Cloud functions: [ovtakt-cloud-functions](https://github.com/bvantagelimited/covtakt-backend) _(this repo)_
...
#### Key Rotation
It is highly recommended that the encryption key is rotated on a regular basis. This step is not included as part of Covtakt.
...
+ `regions`: All regions to deploy the functions to, possible values can be found in: `functions/src/covtakt/types/FunctionConfig.ts` or at Google's [Cloud locations page](https://cloud.google.com/about/locations/).
...
If you have set up either the [Android app](https://github.com/bvantagelimited/covtakt-android) or [iOS app](https://github.com/bvantagelimited/covtakt-ios), you can test the functions by opening the app, going through the registration and verifying that the app displays a pin code in the Upload page.
